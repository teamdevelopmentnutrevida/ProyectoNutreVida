...
namespace TO
{
    ...
    /**
  * Crea un objeto de tranferencia del habito alimentario, además de sus metodos set y get
  * @author Yoselyn
  */
    public class TOHabitoAlimentario
    {
        ...
        public TOHabitoAlimentario(int cedula, int comidaDiaria, char comidaHorasDia, int afueraExpress, string comidaFuera, string azucarBebida, string comidaElaboradCon, decimal aguaDiaria, char aderezos, char fruta, char verdura, char leche, char huevo, char yogurt, char carne, char queso, char aguacate, char semillas)
        {
            Cedula = cedula;
