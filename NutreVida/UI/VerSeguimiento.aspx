    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <tr>
                <td>Ayunas</td>
                <td>
                    <asp:TextBox TextMode="Time" Enabled="false" CssClass="form-control" Font-Size="Small" ID="VerAyunHora" runat="server"></asp:TextBox>
                </td>
                <td>
                    <asp:TextBox CssClass="form-control" Enabled="false" Font-Size="Small" ID="VerAyunDescr" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>Desayuno</td>
                <td>
                    <asp:TextBox TextMode="Time" Enabled="false" CssClass="form-control" Font-Size="Small" ID="VerDesHora" runat="server"></asp:TextBox>
                </td>
                <td>
                    <asp:TextBox CssClass="form-control" Enabled="false" Font-Size="Small" ID="VerDesDescrp" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>Media Mañana</td>
                <td>
                    <asp:TextBox TextMode="Time" Enabled="false" CssClass="form-control" Font-Size="Small" ID="VerMedManHora" runat="server"></asp:TextBox>
                </td>
                <td>
                    <asp:TextBox CssClass="form-control" Enabled="false" Font-Size="Small" ID="VerMedManDesc" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>Almuerzo</td>
                <td>
                    <asp:TextBox TextMode="Time" Enabled="false" CssClass="form-control" Font-Size="Small" ID="VerAlmHora" runat="server"></asp:TextBox>
                </td>
                <td>
                    <asp:TextBox CssClass="form-control" Enabled="false" Font-Size="Small" ID="VerAlmDesc" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>Media Tarde</td>
                <td>
                    <asp:TextBox TextMode="Time" Enabled="false" CssClass="form-control" Font-Size="Small" ID="VerMedTarHora" runat="server"></asp:TextBox>
                </td>
                <td>
                    <asp:TextBox CssClass="form-control" Enabled="false" Font-Size="Small" ID="VerMedTarDesc" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>Cena</td>
                <td>
                    <asp:TextBox TextMode="Time" Enabled="false" CssClass="form-control" Font-Size="Small" ID="VerCenaHora" runat="server"></asp:TextBox>
                </td>
                <td>
                    <asp:TextBox CssClass="form-control" Enabled="false" Font-Size="Small" ID="VerCenaDesc" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>Colación Nocturna</td>
                <td>
                    <asp:TextBox TextMode="Time" Enabled="false" CssClass="form-control" Font-Size="Small" ID="VerColNocHora" runat="server"></asp:TextBox>
                </td>
                <td>
                    <asp:TextBox CssClass="form-control" Enabled="false" Font-Size="Small" ID="VerColNocDesc" runat="server"></asp:TextBox>
                </td>
            </tr>
        </table>
        <br />
