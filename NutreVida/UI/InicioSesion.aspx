            ...
            <div class="col-lg-3 contenido">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <span class="textoPrimario">Sesión</span>
                                    ...
                                    <div class="form-group">
                                        <asp:Label ID="lbContrasena" runat="server" Text="Contraseña:" CssClass="control-label col-sm-2 texto"></asp:Label>
                                        <div class="col-sm-10">
                                            <asp:TextBox ID="txtContrasena" runat="server" TextMode="Password" placeholder="Digitela contraseña" CssClass="form-control col-sm-10  texto"></asp:TextBox>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-11 info-inicio texto">
                            <div class="col-md-10">
